...
/*
    ...
    5-) Select "Electronics" from Product dropdown.
    6-) Enter "25" as quantity number.
    ...
    15-) Enter "242738261027163" as Card Number.
...
public class WO_013_0P_05 extends Hooks {
	...
	void verifyOrderPlacement() throws InterruptedException {
		// 0.Product Name
		orderInformation.add("Electronics");

		// 1.Quantity Number
		orderInformation.add("25");
		...
		Assertions.assertEquals(true, isDisplayed, "You must to enter valid card number.");
